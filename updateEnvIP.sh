...
# Remove line with NEXT_PUBLIC_INTRA_LINK
sed -i.bak "/^NEXT_PUBLIC_INTRA_LINK/d" .env

# Append new line with updated NEXT_PUBLIC_INTRA_LINK
echo "NEXT_PUBLIC_INTRA_LINK=$REDIRECT_LAN" >> .env
