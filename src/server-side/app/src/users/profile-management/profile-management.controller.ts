...
export class ProfileManagementController {
	...
	async sendFriendRequest(
		...
		@Param('receiverId', new ParseIntPipe()) receiverId: number
	...
	async approveFriendRequest(
		@UserId() currentUserId: number,
		@Param('requesterId', new ParseIntPipe()) requesterId: number
	): Promise<Relationship>
	{
	...
	async blockUser(
		@UserId() currentUserId: number,
		@Param('blockeeId', new ParseIntPipe()) blockeeId: number
	): Promise<Boolean> 
	{
	...
	async getLastPendingFriendRequest(
		@UserId() currentUserId: number
	): Promise<UserInfo> 
	{
